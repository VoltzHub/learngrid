...
|---|---|
| Functional PRD v1 + rules (R-UR/R-TV/R-CS/R-PY/R-EP/R-CR/R-RT/R-NT) + 30-screen inventory + data model | `learngrid_workspace.html` (most authoritative) |
| Plain-English version with role pages | `learngrid_team.html` |
| Vision and scope summary | `LearnGrid_Team_Kickoff_Brief.docx` |
| 4-week phased build plan | `LearnGrid_Sprint_0_and_30_Day_Action_Plan.docx` |
| Role clarity / who owns what | `LearnGrid_Role_Clarity_and_Ownership_Guide.docx` |
| Week 1 deliverables (historical) | `learngrid_week1.html` |
| P. James's personal build checklist | `learngrid_pjames_checklist.html` |
| Onboarding flow design handoff (Divine) | `learngrid_onboarding_flow_design_handoff.html` |
| Teacher dashboard design handoff (Divine) | `learngrid_teacher_dashboard_design_handoff.html` |
| 30-screen inventory (tabular) | `LEARNGRID SCREENS.docx` |
