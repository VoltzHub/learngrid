...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: "Login to your Account | LearnGrid",
        description:
            "Login to LearnGrid and start learning. Create your account to discover courses, attend online classes, and build valuable skills.",
        siteName: "LearnGrid",
        type: "website",
        locale: "en_NG",
        images: [
