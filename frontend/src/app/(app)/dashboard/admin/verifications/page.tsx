    ...
    <div style={{ padding: 24, maxWidth: 700, margin: "0 auto" }}>
      ...
      {pending.length === 0 ? (
        <div className="empty-state">
          <div className="empty-state-icon" style={{ color: "var(--d-green)" }}><Icon name="check" size={40} /></div>
          ...
          <div key={tp.userId} style={{ background: "#fff", border: "1px solid var(--d-gray-200)", borderRadius: 14, padding: 20, marginBottom: 16 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              <div>
                ...
                {tp.user.phone && (
                  <p style={{ margin: "2px 0 0", fontSize: 12, color: "var(--d-gray-400)", display: "flex", alignItems: "center", gap: 5 }}>
                    <Icon name="phone" size={13} /> {tp.user.phone}
                  </p>
                )}
              </div>
            ...
            <div className="btn-row">
              <form action={handleApprove}>
                ...
                <button type="submit" className="btn btn-success" style={{ flex: 1, width: "100%", gap: 8 }}>
              ...
              <form action={handleReject} style={{ flex: 1 }}>
                ...
                <button type="submit" className="btn-outline-danger" style={{ width: "100%", gap: 8 }}>
